...
def main() -> int:
    ...
    if len(sys.argv) != 1:
        print("Usage:")
        print("  python -m kachaka_navigation.scripts.undock_shelf")
        return 1
    ...
    try:
        ...
        logger.exception("undock_shelf failed")
        print()
        print("ERROR: Could not undock the shelf.")
        print()
        print("Checklist:")
        print("1. Kachaka is carrying a shelf.")
        print("2. The current location has enough space to unload the shelf.")
